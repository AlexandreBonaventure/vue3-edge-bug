...
var Vue = (function (exports) {
  ...
  const replacer = (_key, val) => {
      if (val instanceof Map) {
          return {
              [`Map(${val.size})`]: [...val.entries()].reduce((entries, ref) => {
                  var key = ref[0];
                  var val = ref[1];
  ...
  function createTransformContext(root, ref) {
      ...
      var hoistStatic = ref.hoistStatic; if ( hoistStatic === void 0 ) hoistStatic = false;
  ...
  function createCodegenContext(ast, ref) {
      ...
      var scopeId = ref.scopeId; if ( scopeId === void 0 ) scopeId = null;
      var optimizeBindings = ref.optimizeBindings; if ( optimizeBindings === void 0 ) optimizeBindings = false;
  ...
  function createForLoopParams(ref) {
      var value = ref.value;
      var key = ref.key;
      var index = ref.index;
  ...
  function baseCompile(template, options = {}) {
      ...
      transform(ast, Object.assign({}, options,
          ...
          directiveTransforms: Object.assign({}, directiveTransforms,
              (options.directiveTransforms || {}))}));
      return generate(ast, Object.assign({}, options,
          {prefixIdentifiers}));
  }
...
`stop,prevent,self,`   +
  ...
  function compile(template, options = {}) {
      return baseCompile(template, Object.assign({}, parserOptions,
          options,
          {nodeTransforms: [...DOMNodeTransforms, ...(options.nodeTransforms || [])],
          directiveTransforms: Object.assign({}, DOMDirectiveTransforms,
              (options.directiveTransforms || {})),
          transformHoist:  null}));
  }
  ...
  function updateHOCHostEl(ref, el // HostNode
  ) {
      var vnode = ref.vnode;
  ...
  function patchSuspense(n1, n2, container, anchor, parentComponent, isSVG, optimized, ref) {
      var patch = ref.p;
  ...
  function moveTeleport(vnode, container, parentAnchor, ref, moveType = 2 /* REORDER */) {
  ...
  function hydrateTeleport(node, vnode, parentComponent, parentSuspense, optimized, ref, hydrateChildren) {
      var ref_o = ref.o;
  ...
  const normalizeKey = (ref) => {
    var key = ref.key;

    return key != null ? key : null;
  };
  const normalizeRef = (ref$1) => {
    var ref = ref$1.ref;
  ...
  */
  ...
  function resolveTransitionHooks(vnode, ref, state, instance) {
      var appear = ref.appear;
      var persisted = ref.persisted; if ( persisted === void 0 ) persisted = false;
      var onBeforeEnter = ref.onBeforeEnter;
      var onEnter = ref.onEnter;
      var onAfterEnter = ref.onAfterEnter;
      var onEnterCancelled = ref.onEnterCancelled;
      var onBeforeLeave = ref.onBeforeLeave;
      var onLeave = ref.onLeave;
      var onAfterLeave = ref.onAfterLeave;
      var onLeaveCancelled = ref.onLeaveCancelled;
  ...
  const KeepAliveImpl = {
      ...
      setup(props, ref) {
          ...
          watch(() => [props.include, props.exclude], (ref) => {
              var include = ref[0];
              var exclude = ref[1];
  ...
  const RuntimeCompiledPublicInstanceProxyHandlers = Object.assign({}, PublicInstanceProxyHandlers,
      {get(target, key) {
  ...
  function createInnerComp(comp, ref) {
      var ref_vnode = ref.vnode;
      var props = ref_vnode.props;
      var children = ref_vnode.children;
  ...
  const TransitionPropsValidators = (Transition.props = Object.assign({}, BaseTransition.props,
      {name: String,
      type: String,
      css: {
          type: Boolean,
  ...
  function resolveTransitionProps(ref) {
      ...
      var rest = objectWithoutProperties( ref, ["name", "type", "css", "duration", "enterFromClass", "enterActiveClass", "enterToClass", "appearFromClass", "appearActiveClass", "appearToClass", "leaveFromClass", "leaveActiveClass", "leaveToClass"] );
      var baseProps = rest;
  ...
  const rendererOptions = Object.assign({}, {patchProp},
      nodeOps);
  ...
  function compileToFunction(template, options) {
      ...
      const { code } = compile(template, Object.assign({}, {hoistStatic: true,
          onError(err) {
              {
